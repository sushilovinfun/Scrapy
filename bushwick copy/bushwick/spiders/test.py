...
class MySpider(CrawlSpider):
    ...
    rules = (Rule(SgmlLinkExtractor(restrict_xpaths="//div[@class='post-button-holder']/div[@class='post-button-older-wrap']/a[@class='post-button-older']")), Rule(SgmlLinkExtractor(restrict_xpaths="//div[@id='center-content']"), callback='parse_items'),)
