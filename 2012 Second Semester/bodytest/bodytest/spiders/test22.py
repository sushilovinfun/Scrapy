...
class MySpider(CrawlSpider):
    ...
    rules = (
            ...
            Rule(SgmlLinkExtractor(restrict_xpaths="//div[@id='pagecontent']/table[2]/tr/td[2]/a"), callback='parse_topic'),
            Rule(SgmlLinkExtractor(restrict_xpaths="//div[@id='pagecontent']/table[1]/tr/td[4]/b/a"), callback='parse_topic', follow=True),
            Rule(SgmlLinkExtractor(deny="http://genofond.org/viewtopic.php.f=9&start=0&t=\d+")),
            Rule(SgmlLinkExtractor(deny="http://genofond.org/viewtopic.php.f=9&t=\d+")),
            )
